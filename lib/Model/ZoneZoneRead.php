...
/**
 * ZoneZoneRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class ZoneZoneRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Zone-zone.read';
    ...
    protected static $openAPITypes = [
        ...
        'records' => 'object[]',
        'nameservers' => '\NETZFABRIK\Model\ZoneNameserverZoneRead[]'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ZoneZoneRead., must be smaller than or equal to 255.');
        }
    ...
    public function setRefresh($refresh)
    {
        ...
        if (($refresh > 604800)) {
            throw new \InvalidArgumentException('invalid value for $refresh when calling ZoneZoneRead., must be smaller than or equal to 604800.');
        }
        if (($refresh <= 60)) {
            throw new \InvalidArgumentException('invalid value for $refresh when calling ZoneZoneRead., must be bigger than 60.');
        }
    ...
    public function setRetry($retry)
    {
        ...
        if (($retry > 604800)) {
            throw new \InvalidArgumentException('invalid value for $retry when calling ZoneZoneRead., must be smaller than or equal to 604800.');
        }
        if (($retry <= 60)) {
            throw new \InvalidArgumentException('invalid value for $retry when calling ZoneZoneRead., must be bigger than 60.');
        }
    ...
    public function setExpire($expire)
    {
        ...
        if (($expire > 604800)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling ZoneZoneRead., must be smaller than or equal to 604800.');
        }
        if (($expire <= 60)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling ZoneZoneRead., must be bigger than 60.');
        }
    ...
    public function setTtl($ttl)
    {
        ...
        if (($ttl > 604800)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling ZoneZoneRead., must be smaller than or equal to 604800.');
        }
        if (($ttl <= 60)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling ZoneZoneRead., must be bigger than 60.');
        }
     ...
     * Gets nameservers
     *
     * @return \NETZFABRIK\Model\ZoneNameserverZoneRead[]|null
     */
     ...
     * Sets nameservers
     *
     * @param \NETZFABRIK\Model\ZoneNameserverZoneRead[]|null $nameservers nameservers
     *
     * @return self
     */
