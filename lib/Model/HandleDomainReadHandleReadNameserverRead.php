...
/**
 * HandleDomainReadHandleReadNameserverRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class HandleDomainReadHandleReadNameserverRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Handle-domain.read_handle.read_nameserver.read';
    ...
    */
    ...
    public function setPhone1($phone1)
    {
        ...
        if ((!preg_match("/^(\\+\\d{1,3})$/", $phone1))) {
            throw new \InvalidArgumentException("invalid value for \$phone1 when calling HandleDomainReadHandleReadNameserverRead., must conform to the pattern /^(\\+\\d{1,3})$/.");
        }
    ...
    public function setPhone2($phone2)
    {
        ...
        if ((!preg_match("/^(\\d{1,5})$/", $phone2))) {
            throw new \InvalidArgumentException("invalid value for \$phone2 when calling HandleDomainReadHandleReadNameserverRead., must conform to the pattern /^(\\d{1,5})$/.");
        }
    ...
    public function setPhone3($phone3)
    {
        ...
        if ((!preg_match("/^(\\d{1,15})$/", $phone3))) {
            throw new \InvalidArgumentException("invalid value for \$phone3 when calling HandleDomainReadHandleReadNameserverRead., must conform to the pattern /^(\\d{1,15})$/.");
        }
    ...
    public function setFax1($fax1)
    {
        ...
        if (!is_null($fax1) && (!preg_match("/^(\\+\\d{1,3})$/", $fax1))) {
            throw new \InvalidArgumentException("invalid value for \$fax1 when calling HandleDomainReadHandleReadNameserverRead., must conform to the pattern /^(\\+\\d{1,3})$/.");
        }
    ...
    public function setFax2($fax2)
    {
        ...
        if (!is_null($fax2) && (!preg_match("/^(\\d{1,5})$/", $fax2))) {
            throw new \InvalidArgumentException("invalid value for \$fax2 when calling HandleDomainReadHandleReadNameserverRead., must conform to the pattern /^(\\d{1,5})$/.");
        }
    ...
    public function setFax3($fax3)
    {
        ...
        if (!is_null($fax3) && (!preg_match("/^(\\d{1,15})$/", $fax3))) {
            throw new \InvalidArgumentException("invalid value for \$fax3 when calling HandleDomainReadHandleReadNameserverRead., must conform to the pattern /^(\\d{1,15})$/.");
        }
