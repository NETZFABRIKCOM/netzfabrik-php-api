...
/**
 * UserChangePasswordRequestDefault Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class UserChangePasswordRequestDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User.ChangePasswordRequest-Default';
    ...
    */
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserChangePasswordRequestDefault., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^(.*[!@#$%^&*()\\-_=+{};:,<.>].*)$/", $password))) {
            throw new \InvalidArgumentException("invalid value for \$password when calling UserChangePasswordRequestDefault., must conform to the pattern /^(.*[!@#$%^&*()\\-_=+{};:,<.>].*)$/.");
        }
    ...
    public function setRepeatPassword($repeatPassword)
    {
        if (is_null($repeatPassword)) {
            throw new \InvalidArgumentException('non-nullable repeatPassword cannot be null');
        }
