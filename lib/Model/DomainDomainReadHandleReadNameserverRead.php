...
/**
 * DomainDomainReadHandleReadNameserverRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class DomainDomainReadHandleReadNameserverRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Domain-domain.read_handle.read_nameserver.read';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'adminHandle' => '\NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle',
        'techHandle' => '\NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle',
        'ownerHandle' => '\NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle',
        'zoneHandle' => '\NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle',
        ...
        'status' => 'string',
        'nameservers' => '\NETZFABRIK\Model\NameserverDomainReadHandleReadNameserverRead[]',
        'transitType' => 'string',
        'dnsZoneId' => 'string'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'name' => 'setName',
        'adminHandle' => 'setAdminHandle',
        'techHandle' => 'setTechHandle',
        'ownerHandle' => 'setOwnerHandle',
        'zoneHandle' => 'setZoneHandle',
    ...
    protected static $getters = [
        ...
        'techHandle' => 'getTechHandle',
        'ownerHandle' => 'getOwnerHandle',
        'zoneHandle' => 'getZoneHandle',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('adminHandle', $data ?? [], null);
        $this->setIfExists('techHandle', $data ?? [], null);
        $this->setIfExists('ownerHandle', $data ?? [], null);
        $this->setIfExists('zoneHandle', $data ?? [], null);
    ...
    */
     ...
     * Gets adminHandle
     *
     * @return \NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle|null
     */
    public function getAdminHandle()
    {
        return $this->container['adminHandle'];
    }

    /**
     * Sets adminHandle
     *
     * @param \NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle|null $adminHandle adminHandle
     *
     * @return self
     */
    public function setAdminHandle($adminHandle)
    {
        if (is_null($adminHandle)) {
            array_push($this->openAPINullablesSetToNull, 'adminHandle');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('adminHandle', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['adminHandle'] = $adminHandle;
    ...
    {
        return $this->container['techHandle'];
    }

    /**
     * Sets techHandle
     *
     * @param \NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle|null $techHandle techHandle
     *
     * @return self
     */
    public function setTechHandle($techHandle)
    {
        if (is_null($techHandle)) {
            array_push($this->openAPINullablesSetToNull, 'techHandle');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('techHandle', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['techHandle'] = $techHandle;
    ...
    {
        return $this->container['ownerHandle'];
    }

    /**
     * Sets ownerHandle
     *
     * @param \NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle|null $ownerHandle ownerHandle
     *
     * @return self
     */
    public function setOwnerHandle($ownerHandle)
    {
        if (is_null($ownerHandle)) {
            array_push($this->openAPINullablesSetToNull, 'ownerHandle');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ownerHandle', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ownerHandle'] = $ownerHandle;
     ...
     * @return \NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle|null
     */
    public function getZoneHandle()
    {
        return $this->container['zoneHandle'];
    }

    /**
     * Sets zoneHandle
     *
     * @param \NETZFABRIK\Model\DomainDomainReadHandleReadNameserverReadAdminHandle|null $zoneHandle zoneHandle
     *
     * @return self
     */
    public function setZoneHandle($zoneHandle)
    {
        if (is_null($zoneHandle)) {
            array_push($this->openAPINullablesSetToNull, 'zoneHandle');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('zoneHandle', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['zoneHandle'] = $zoneHandle;
     ...
     * Gets nameservers
     *
     * @return \NETZFABRIK\Model\NameserverDomainReadHandleReadNameserverRead[]|null
     */
     ...
     * Sets nameservers
     *
     * @param \NETZFABRIK\Model\NameserverDomainReadHandleReadNameserverRead[]|null $nameservers nameservers
     *
     * @return self
     */
