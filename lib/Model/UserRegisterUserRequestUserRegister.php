...
/**
 * UserRegisterUserRequestUserRegister Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class UserRegisterUserRequestUserRegister implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User.RegisterUserRequest-user.register';
    ...
    */
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserRegisterUserRequestUserRegister., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^(.*[!@#$%^&*()\\-_=+{};:,<.>].*)$/", $password))) {
            throw new \InvalidArgumentException("invalid value for \$password when calling UserRegisterUserRequestUserRegister., must conform to the pattern /^(.*[!@#$%^&*()\\-_=+{};:,<.>].*)$/.");
        }
