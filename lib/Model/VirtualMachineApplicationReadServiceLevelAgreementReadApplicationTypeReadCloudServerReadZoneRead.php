...
/**
 * VirtualMachineApplicationReadServiceLevelAgreementReadApplicationTypeReadCloudServerReadZoneRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class VirtualMachineApplicationReadServiceLevelAgreementReadApplicationTypeReadCloudServerReadZoneRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualMachine-application.read_service_level_agreement.read_application_type.read_cloud-server.read_zone.read';
