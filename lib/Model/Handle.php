 ...
 */
class Handle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Handle';
    ...
    protected static $openAPITypes = [
        ...
        'fax3' => 'string',
        'type' => 'string',
        'registrarRelations' => '\NETZFABRIK\Model\DomainRegistrarHandle[]',
        'createdAt' => '\DateTime',
        'updatedAt' => '\DateTime',
        'customer' => 'string',
        'phone' => '\NETZFABRIK\Model\PhoneNumber',
        'fax' => '\NETZFABRIK\Model\PhoneNumber'
    ];
    ...
    protected static $attributeMap = [
        ...
        'fax3' => 'fax3',
        'type' => 'type',
        'registrarRelations' => 'registrarRelations',
        'createdAt' => 'createdAt',
        'updatedAt' => 'updatedAt',
        'customer' => 'customer',
        'phone' => 'phone',
    ...
    protected static $setters = [
        ...
        'fax3' => 'setFax3',
        'type' => 'setType',
        'registrarRelations' => 'setRegistrarRelations',
    ...
    protected static $getters = [
        ...
        'fax3' => 'getFax3',
        'type' => 'getType',
        'registrarRelations' => 'getRegistrarRelations',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('registrarRelations', $data ?? [], null);
    ...
    */
    ...
    public function setPhone1($phone1)
    {
        ...
        if ((!preg_match("/^(\\+\\d{1,3})$/", $phone1))) {
            throw new \InvalidArgumentException("invalid value for \$phone1 when calling Handle., must conform to the pattern /^(\\+\\d{1,3})$/.");
        }
    ...
    public function setPhone2($phone2)
    {
        ...
        if ((!preg_match("/^(\\d{1,5})$/", $phone2))) {
            throw new \InvalidArgumentException("invalid value for \$phone2 when calling Handle., must conform to the pattern /^(\\d{1,5})$/.");
        }
    ...
    public function setPhone3($phone3)
    {
        ...
        if ((!preg_match("/^(\\d{1,15})$/", $phone3))) {
            throw new \InvalidArgumentException("invalid value for \$phone3 when calling Handle., must conform to the pattern /^(\\d{1,15})$/.");
        }
    ...
    public function setFax1($fax1)
    {
        ...
        if (!is_null($fax1) && (!preg_match("/^(\\+\\d{1,3})$/", $fax1))) {
            throw new \InvalidArgumentException("invalid value for \$fax1 when calling Handle., must conform to the pattern /^(\\+\\d{1,3})$/.");
        }
    ...
    public function setFax2($fax2)
    {
        ...
        if (!is_null($fax2) && (!preg_match("/^(\\d{1,5})$/", $fax2))) {
            throw new \InvalidArgumentException("invalid value for \$fax2 when calling Handle., must conform to the pattern /^(\\d{1,5})$/.");
        }
    ...
    public function setFax3($fax3)
    {
        ...
        if (!is_null($fax3) && (!preg_match("/^(\\d{1,15})$/", $fax3))) {
            throw new \InvalidArgumentException("invalid value for \$fax3 when calling Handle., must conform to the pattern /^(\\d{1,15})$/.");
        }
    ...
    /**
     * Gets registrarRelations
     *
     * @return \NETZFABRIK\Model\DomainRegistrarHandle[]|null
     */
    public function getRegistrarRelations()
    {
        return $this->container['registrarRelations'];
    }

    /**
     * Sets registrarRelations
     *
     * @param \NETZFABRIK\Model\DomainRegistrarHandle[]|null $registrarRelations registrarRelations
     *
     * @return self
     */
    public function setRegistrarRelations($registrarRelations)
    {
        if (is_null($registrarRelations)) {
            throw new \InvalidArgumentException('non-nullable registrarRelations cannot be null');
        }
        $this->container['registrarRelations'] = $registrarRelations;
     ...
     * Gets phone
     *
     * @return \NETZFABRIK\Model\PhoneNumber|null
     */
     ...
     * Sets phone
     *
     * @param \NETZFABRIK\Model\PhoneNumber|null $phone phone
     *
     * @return self
     */
     ...
     * Sets fax
     *
     * @param \NETZFABRIK\Model\PhoneNumber|null $fax fax
     *
     * @return self
     */
