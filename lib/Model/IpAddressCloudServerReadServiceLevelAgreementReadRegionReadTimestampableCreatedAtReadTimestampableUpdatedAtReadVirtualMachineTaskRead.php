...
/**
 * IpAddressCloudServerReadServiceLevelAgreementReadRegionReadTimestampableCreatedAtReadTimestampableUpdatedAtReadVirtualMachineTaskRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class IpAddressCloudServerReadServiceLevelAgreementReadRegionReadTimestampableCreatedAtReadTimestampableUpdatedAtReadVirtualMachineTaskRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IpAddress-cloud-server.read_service_level_agreement.read_region.read_timestampable.created_at.read_timestampable.updated_at.read_virtual_machine_task.read';
