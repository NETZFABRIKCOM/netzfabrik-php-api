...
/**
 * IpAddressCloudServerListRegionReadTimestampableCreatedAtReadTimestampableUpdatedAtRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class IpAddressCloudServerListRegionReadTimestampableCreatedAtReadTimestampableUpdatedAtRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IpAddress-cloud-server.list_region.read_timestampable.created_at.read_timestampable.updated_at.read';
