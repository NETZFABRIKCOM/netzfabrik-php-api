...
/**
 * ZoneZoneList Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  NETZFABRIK
 ...
 */
class ZoneZoneList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Zone-zone.list';
    ...
    protected static $openAPITypes = [
        ...
        'ttl' => 'int',
        'type' => 'string',
        'nameservers' => '\NETZFABRIK\Model\ZoneNameserverZoneList[]'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ZoneZoneList., must be smaller than or equal to 255.');
        }
    ...
    public function setRefresh($refresh)
    {
        ...
        if (($refresh > 604800)) {
            throw new \InvalidArgumentException('invalid value for $refresh when calling ZoneZoneList., must be smaller than or equal to 604800.');
        }
        if (($refresh <= 60)) {
            throw new \InvalidArgumentException('invalid value for $refresh when calling ZoneZoneList., must be bigger than 60.');
        }
    ...
    public function setRetry($retry)
    {
        ...
        if (($retry > 604800)) {
            throw new \InvalidArgumentException('invalid value for $retry when calling ZoneZoneList., must be smaller than or equal to 604800.');
        }
        if (($retry <= 60)) {
            throw new \InvalidArgumentException('invalid value for $retry when calling ZoneZoneList., must be bigger than 60.');
        }
    ...
    public function setExpire($expire)
    {
        ...
        if (($expire > 604800)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling ZoneZoneList., must be smaller than or equal to 604800.');
        }
        if (($expire <= 60)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling ZoneZoneList., must be bigger than 60.');
        }
    ...
    public function setTtl($ttl)
    {
        ...
        if (($ttl > 604800)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling ZoneZoneList., must be smaller than or equal to 604800.');
        }
        if (($ttl <= 60)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling ZoneZoneList., must be bigger than 60.');
        }
     ...
     * Gets nameservers
     *
     * @return \NETZFABRIK\Model\ZoneNameserverZoneList[]|null
     */
     ...
     * Sets nameservers
     *
     * @param \NETZFABRIK\Model\ZoneNameserverZoneList[]|null $nameservers nameservers
     *
     * @return self
     */
