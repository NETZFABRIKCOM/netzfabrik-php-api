    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ZoneRecord., must be smaller than or equal to 255.');
        }
    ...
    public function setContent($content)
    {
        ...
        if ((mb_strlen($content) > 255)) {
            throw new \InvalidArgumentException('invalid length for $content when calling ZoneRecord., must be smaller than or equal to 255.');
        }
    ...
    public function setTtl($ttl)
    {
        ...
        if (($ttl > 86400)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling ZoneRecord., must be smaller than or equal to 86400.');
        }
        if (($ttl <= 1)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling ZoneRecord., must be bigger than 1.');
        }
